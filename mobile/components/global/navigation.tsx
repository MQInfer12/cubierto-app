  ...
  return (
    <View style={styles.container}>
      <View style={styles.buttonContainer}>
        ...
        <FontedText weight={700} style={styles.backText}>
          {route}
        </FontedText>
      </View>
      {cola ? (
        ...
        <View style={styles.logoContainer}>
          <Image
            style={styles.logoCocha}
            source={require("../../assets/images/WebCubiertoLogos-03.png")}
          />
          {/* <FontedText weight={600} style={styles.logoText}>
            Cubierto
          </FontedText> */}
          <Image
            style={styles.logo}
            source={require("../../assets/images/CubiertoIsotipo.png")}
          />
        </View>
      )}
    </View>
